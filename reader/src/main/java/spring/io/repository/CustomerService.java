...
@Component
public class CustomerService extends ItemStreamSupport implements ItemReader<Customer> {
    ...
    private Customer buildCustomer() {
        ...
        customer.setState(cities[generator.nextInt(states.length - 1)]);
        customer.setZipCode(String.valueOf(generator.nextInt(9999)));
    ...
    public Customer read() {
        ...
        if (curIndex < customer.size()) {
            cust = customer.get(curIndex);
            curIndex++;
        }
        return cust;
    }
